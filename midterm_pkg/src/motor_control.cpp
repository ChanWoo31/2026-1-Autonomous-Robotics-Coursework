...
class motor_control : public rclcpp::Node
{
    ...
    motor_control(): Node("motor_control")
    {
        ...
        lidar_angle_subscriber_ = this->create_subscription<std_msgs::msg::Int32MultiArray>(
            "/lidar_angle", 10,
            std::bind(&motor_control::lidar_angle_callback,this,_1)
        );
    ...
    void lidar_angle_callback(std_msgs::msg::Int32MultiArray::SharedPtr _msg)
    {
        // lidar 총 개수 720개.
        set_angle_1 = _msg->data[0];
        set_angle_2 = _msg->data[1];
    ...
    void lidar_callback(sensor_msgs::msg::LaserScan::SharedPtr _msg)
    {
        ...
        int start_deg = std::min(set_angle_1, set_angle_2);
        int end_deg = std::max(set_angle_1, set_angle_2);
    ...
    rclcpp::Subscription<std_msgs::msg::Int32MultiArray>::SharedPtr lidar_angle_subscriber_;
